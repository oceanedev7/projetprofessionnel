<a href="{{ route('accueil') }}" class="bg-gray-400 bg-opacity-65 text-white py-2.5 px-3 absolute left-8 top-8 rounded"><i class="fa-solid fa-house text-white text-xl "></i></a>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="block mt-4">
            <label for="remember_me" class="inline-flex items-center">
                ...
                <span class="ms-2 text-sm dark:text-gray-400">{{ __('Se souvenir de moi') }}</span>
            </label>
        </div>
    ...
    <a href="{{route ('register')}}" class="hover:underline"> Vous n'avez pas encore de compte ? Inscrivez-vous ! </a>
    </div>
