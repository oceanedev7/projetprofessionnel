...
<h1 class="p-12 mt-12 md:mt-0 md:text-left text-center md:p-0 md:ml-32 md:mt-52 text-6xl text-white font-bold uppercase"> {!! nl2br(__('content.cgv-1')) !!} </h1>
<hr class="hidden md:block border-t-4 border-custom-beige w-32 relative top-6 left-32">
</div>
@endsection
