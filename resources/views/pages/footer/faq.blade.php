 ...
 @section ('titre')
        ...
        <div class="border border-custom-vert rounded-lg space-y-2">
            <h2 id="accordion-flush-heading-5">
                <button type="button" class="flex items-center justify-between font-medium text-white dark:text-gray-400 hover:bg-custom-vert transition-all" data-accordion-target="#accordion-flush-body-5" aria-expanded="false" aria-controls="accordion-flush-body-5">
         ...
         <div class="border border-custom-vert rounded-lg space-y-2">
            <h2 id="accordion-flush-heading-6">
                <button type="button" class="flex items-center justify-between font-medium text-white dark:text-gray-400 hover:bg-custom-vert transition-all text-left" data-accordion-target="#accordion-flush-body-6" aria-expanded="false" aria-controls="accordion-flush-body-6">
        ...
        <div class="border border-custom-vert rounded-lg space-y-2">
            <h2 id="accordion-flush-heading-7">
                <button type="button" class="flex items-center justify-between font-medium text-white dark:text-gray-400 hover:bg-custom-vert transition-all" data-accordion-target="#accordion-flush-body-7" aria-expanded="false" aria-controls="accordion-flush-body-7">
            ...
            <div id="accordion-flush-body-7" class="hidden" aria-labelledby="accordion-flush-heading-1">
                <div class=" bg-custom-vert text-white">
