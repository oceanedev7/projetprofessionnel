...
@section('title', __('content.disponibilite'))
    ...
    <div class=" z-10 w-full"> 
        <a href="{{ route('menu') }}" class="absolute top-4 left-8 bg-gray-800 bg-opacity-65 text-white py-2.5 px-3 border-none rounded-md w-12 text-base inline-block text-center"><i class="fa-solid fa-bars"></i></a>    
        @if(Auth::check())
    ...
    @else
        <a href="{{ route('login') }}" class="absolute top-4 right-24 bg-gray-800 bg-opacity-65 text-white py-2.5 px-3 font-bold border-none inline-block text-center rounded w-12 tracking-wide text-base">
