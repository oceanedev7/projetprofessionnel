...
@section('title', __('content.reserver'))
...
<div class="flex justify-end mr-12 space-x-6 relative top-6">
 <div class="text-custom-beige font-bold text-sm relative top-6 "> {{ __('content.adultes') }} </div>
 <div class="text-custom-beige font-bold text-sm"> {!! nl2br(__('content.enfants')) !!}</div>
</div>
