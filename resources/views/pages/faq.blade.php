...
{{-- <header>
    <div class="bg-custom-vert w-full" >
        <div class="flex flex-row"> 
            <img class="w-[550px] h-screen" src="{{ Storage::url('images/cgv.jpg') }}" alt="Cabane intérieur">
     </div>


     <h1 class="relative top-0 left-40  text-5xl text-white font-bold"> Questions <br/> & Réponses </h1>
         ...
         <div id="accordion-flush" data-accordion="collapse" data-active-classes="bg-custom-vert dark:bg-gray-900 text-gray-900 text-custom-beige dark:text-white" data-inactive-classes="text-gray-500 dark:text-gray-400">
             ...
             <h2 id="accordion-flush-heading-2">
               <button type="button" class="flex items-center justify-between w-full py-5 font-medium rtl:text-right text-white dark:text-gray-400 gap-3" data-accordion-target="#accordion-flush-body-2" aria-expanded="false" aria-controls="accordion-flush-body-2">
                 <span class="text-lg">Quels sont les équipements disponibles dans les cabanes ?</span>
                 <svg data-accordion-icon class="w-3 h-3 rotate-180 shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                   <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5 5 1 1 5"/>
                 </svg>
               </button>
     ...
     <div id="accordion-flush-body-7" class="hidden" aria-labelledby="accordion-flush-heading-7">
         <div>
             <p class="mb-2 text-white">L’arrivée se fait à partir de 16h et jusqu'à 18h et le départ jusqu'à 11H. Ceci dit, 
...
<header>
    <div class="bg-custom-vert flex flex-row items-center h-screen w-full">

        <img class="w-[550px] h-screen" src="{{ Storage::url('images/cgv.jpg') }}" alt="Cabane intérieur">


        <div class="flex flex-col  text-white text-justify">
           <h1 class="relative top-56 ml-44 text-5xl text-white  font-bold ">
                Questions <br/> & Réponses
            </h1>

        
            <div class="relative top-56 ml-32 mr-32" id="accordion-flush" data-accordion="collapse" data-active-classes="bg-custom-vert dark:bg-gray-900 text-gray-900 text-custom-beige dark:text-white" data-inactive-classes="text-gray-500 dark:text-gray-400">
                <h2 id="accordion-flush-heading-1">
                    <button type="button" class="flex items-center justify-between w-full py-5 font-medium rtl:text-right text-white dark:text-gray-400 gap-3" data-accordion-target="#accordion-flush-body-1" aria-expanded="true" aria-controls="accordion-flush-body-1">
                        <span class="text-lg">Quels types de cabanes proposez-vous ?</span>
                        <svg data-accordion-icon class="w-3 h-3 rotate-180 shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
