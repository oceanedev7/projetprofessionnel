...
<div style="background-color:#F9F4EE" class="h-screen w-full"> 
    ...
    <img class="w-[550px] h-screen" src="{{ Storage::url('images/cabane.jpg') }}" alt="Cabane intérieur">
...
<div class="flex justify-center" >
    <a class="bg-custom-marron text-white font-bold text-base px-4 py-2 rounded-md relative top-28">DECOUVRIR LES PRESTATIONS ET SERVICES</a>
</div>
...
<div class="w-full h-screen bg-custom-beige text-white"> 

    <img class="w-full h-screen object-cover opacity-20" src="{{ Storage::url('images/reservation.jpg') }}" alt="Cabane au bord de l'eau">

<div class="flex flex-col justify-center items-center relative bottom-96">

    <div class="font-bold text-3xl"> Bon à savoir !</div>
    <div class="text-justify font-semibold text-lg max-w-3xl mt-12"> 
        ARRIVÉE : À partir de 16h et jusqu'à 18h
        Arrivée tardive possible jusqu'à 20h sur demande (prévenir 48h avant votre séjour)
        DÉPART : Jusqu'à 11H
